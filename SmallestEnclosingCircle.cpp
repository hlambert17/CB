...
PYBIND11_MODULE(SmallestEnclosingCircle, m) {
    m.doc() = "Smallest enclosing circle c++ module"; // optional module docstring

    m.def("makeSmallestEnclosingCircle", &makeSmallestEnclosingCircle, "A function which finds the smallest enclosing circle from a cloud of points");
}
